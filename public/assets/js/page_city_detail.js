            ...
            var golo_create_markers = function (data, map) {
                ...
                $.each(data, function (i, value) {
                    ...
                    var html_infowindow = `
                        <div id='infowindow'>
                            <div class="places-item" data-title="${value.name}" data-lat="-33.796864" data-lng="150.620614" data-index="${i}">
                                <a href="/place/${value.slug}"><img src="https://insta-help.s3.amazonaws.com/${value.thumb}" alt=""></a>
                    ...
                    if (value.categories[0].icon_map_marker) {
                        marker_options.icon = {
                            url: `https://insta-help.s3.amazonaws.com/${value.categories[0].icon_map_marker}`
                        }
                    }
