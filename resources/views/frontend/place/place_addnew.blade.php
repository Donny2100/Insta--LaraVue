    ...
    <main id="main" class="site-main listing-main">
                ...
                <form class="upload-form" id="new_place" action="{{route('place_create')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="listing-box" id="location">
                        ...
                        <div class="field-clone">
                            {{-- <div class="field-inline field-3col"> --}}
                                ...
                                <div class="field-group field-select">
                                    <select name="state_id" class="custom-select" id="select_state" required>
                    ...
                    <div class="listing-box" id="contact">
                        ...
                        <div class="field-group">
                            ...
                            <input type="email" id="place_email" value="{{$place['email']}}" placeholder="{{__('Your email address')}}" name="email" required>
                        </div>
                        <div class="field-group">
                            <label for="place_number">{{__('Phone number')}}</label>
                            <input type="tel" id="place_number" value="{{$place['phone_number']}}" placeholder="{{__('Your phone number')}}" name="phone_number" required>
                        </div>
                        <div class="field-group">
        ...
        @else
            <div class="listing-content">
                ...
                <p>Please upgrade to a business account subscribing on your <a href="{{ route('payment_info') }}">payment info page</a></p>
            </div>
        @endif
    </main><!-- .site-main -->
@stop
