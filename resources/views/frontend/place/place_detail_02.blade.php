            ...
            <div class="slick-sliders">
                <div class="slick-slider photoswipe" data-item="1" data-arrows="false" data-itemScroll="1" data-dots="false" data-infinite="false" data-centerMode="false" data-centerPadding="0">
                    @if(isset($place->gallery))
                        ...
                        @endforeach
                    @else
                        <div class="place-slider__item"><a href="#"><img src="https://via.placeholder.com/1280x500?text=InstaHelp" alt="slider no image"></a></div>
                    @endif
                <input id="usrtk" value="{{ Auth::user()->api_token }}" type="hidden" />
                </div>
                                    ...
                                    <div class="review-form">
                                        ...
                                        <form id="submit_review">
                                            ...
                                            <div class="field-textarea">
                                                <img class="author-avatar" src="{{s3(user()->avatar)}}" alt="">
...
@push('scripts')
    ...
    <script src="{{asset('assets/js/page_place_chat.js')}}"></script>
@endpush
