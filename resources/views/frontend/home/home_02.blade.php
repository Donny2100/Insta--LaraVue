                        ...
                        @foreach($popular_cities as $city)
                            <div class="slick-item">
                                <div class="cities__item hover__box">
                                    ...
                                    <h5 class="states__name">{{$city['state']['name']}}</h5>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="business-about-info">
                            <h2>{{__('Who we are')}}</h2>
                            <p>{{__("This is where you will talk about your business, your team, your mission, and how this site will help business owners and users. Send us your text and we will enter it here. \r\n Keep it down to 2-3 paragraphs maximum. ")}}</p>
