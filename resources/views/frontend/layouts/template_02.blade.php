            ...
            <div class="row">
                <div class="col-md-6 col-8">
                    <div class="site">                        
                        <div class="site__brand">
                            <a title="Logo" href="{{route('home')}}" class="site__brand__logo"><img src="{{s3(setting('logo'))}}" alt="Insta Help"></a>
                        </div><!-- .site__brand -->
                        @unless(isRoute('home'))
                ...
                <div class="col-md-6 col-4">
                    <div class="right-header align-right">
                        ...
                        @else
                            <div class="account">
                                <a href="#" title="{{Auth::user()->name}}">
                                    <img src="{{s3(user()->avatar)}}" alt="{{Auth::user()->name}}">
                                    <span>
										{{Auth::user()->name}}
                        ...
                        @else
                            <div class="right-header__button btn">
                                <a title="My place" href="{{route('user_my_place')}}">
                                    <i class="las la-building la-24-white"></i>
                                    <span>My place</span>
                                </a>
                            </div><!-- .right-header__button -->
                        @endif
    ...
    <footer id="footer" class="footer layout-02">
        <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-5">
                        <div class="footer__top__info">
                            <a title="Logo" href="#" class="footer__top__info__logo"><img src="{{s3(setting('logo'))}}" alt="Insta Help"></a>
                    ...
                    <div class="col-lg-3">
                        <aside class="footer__top__nav footer__top__nav--contact">
                            <h3>{{__('Contact Us')}}</h3>
                            <p>{{__('Email: info@instahelp.com')}}</p>
                            <p>{{__('Phone: (504) 555-5555')}}</p>
                            <ul>
                                <li>
            ...
            <div class="footer__bottom">
                <p class="footer__bottom__copyright">{{__('Managed by ')}}<a href="{{__('https://vyudu.com/')}}" target="_blank">{{__('Vyudu Inc')}}</a>. {{now()->year}} &copy; {{__('Instalhelp. All rights reserved.')}}</p>
            </div><!-- .top-footer -->
        </div><!-- .container -->
    </footer><!-- site-footer -->
    @if(isRoute('home'))
        @php
            ...
            if (setting('home_banner_app')) {
                ...
                $home_banner_app = "style=background-image:url(/assets/images/bg-app.jpg)";
            }
        @endphp
