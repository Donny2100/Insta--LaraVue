                ...
                <div class="col-md-6 col-8">
                    <div class="site">                        
                        <div class="site__brand">
                            <a title="Logo" href="{{route('home')}}" class="site__brand__logo"><img src="{{s3(setting('logo'))}}" alt="logo"></a>
                        </div><!-- .site__brand -->
    ...
    <footer id="footer" class="footer">
        <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-5">
                        <div class="footer__top__info">
                            <a title="Logo" href="#" class="footer__top__info__logo"><img src="{{s3(setting('logo'))}}" alt="logo"></a>
            ...
            <div class="footer__bottom">
                <p class="footer__bottom__copyright">{{now()->year}} &copy; <a href="{{__('/')}}">{{__('Insta Help')}}</a>. {{__('All rights reserved.')}}</p>
            </div><!-- .top-footer -->
        </div><!-- .container -->
    </footer><!-- site-footer -->
</div><!-- #wrapper -->
