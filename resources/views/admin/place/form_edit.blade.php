        ...
        <div id="location">
            ...
            <div class="row">
                <div class="form-group col-md-4">
                    <input id="country-hidden" type="hidden" value="{{$place->country_id}}">
                    <input id="state-hidden" type="hidden" value="{{$place->state_id}}">
                    <input id="city-hidden" type="hidden" value="{{$place->city_id}}">
