<div class="left_col scroll-view">
    <div class="navbar nav_title border-0">
        <a href="{{route('admin_dashboard')}}" class="site_title"><img src="{{s3(setting('logo'))}}" alt="Insta Help" style="max-width: 90%"></a>
    </div>
            ...
            <ul class="nav side-menu">
                ...
                <li id="menu_place">
                    ...
                    <ul class="nav child_menu">
                        ...
                        <li><a href="{{route('admin_state_list')}}"><i class="fa fa-flag"></i> States</a></li>
