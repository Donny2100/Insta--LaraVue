						...
						<div class="col-md-12 city_create">
							...
							<div class="form-group">
								...
								<select class="form-control" id="state_id" name="state_id" required>
									<option value="" hidden>-- Select a country first --</option>
								</select>
							</div>
									...
									<div class="tab-pane fade show {{$index !== 0 ?: "active"}}" id="language_{{$language->code}}" role="tabpanel" aria-labelledby="home-tab">
										<div class="form-group">
											<label for="city_name">City name
												...
												: *</label>
											<input id="city_name" type="text" class="form-control" name="{{$language->code}}[name]" {{$index !== 0 ?: "required"}}>
										</div>
										<div class="form-group">
											<label for="city_intro">Intro
												<small>({{$language->code}})</small>
												: *</label>
											<input id="city_intro" type="text" class="form-control" name="{{$language->code}}[intro]" REQUIRED>
										</div>
										<div class="form-group">
											<label for="city_description">Description
												<small>({{$language->code}})</small>
												: *</label>
											<textarea id="city_description" class="form-control" name="{{$language->code}}[description]" rows="5" required></textarea>
										</div>
									</div>
								@endforeach
							</div>
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" id="city_time_to_visit" name="best_time_to_visit" required>
							</div>

							<div class="row">
								<div class="form-group col-md-6">
									<label for="city_currency">Currency: *</label>
									<input type="text" class="form-control" id="city_currency" name="currency" required>
								</div>
								<div class="form-group col-md-6">
									<label for="city_language">Language: *</label>
									<input type="text" class="form-control" id="city_language" name="language" required>
								</div>
							</div>
