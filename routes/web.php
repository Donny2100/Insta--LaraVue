...
$router->get('/upgrade', 'Admin\UpgradeController@upgrade')->name('upgrade');
...
$router->group([
    ...
    $router->get('/state', 'StatesController@index')->name('state_list');
    $router->post('/state', 'StatesController@create')->name('state_create');
    $router->put('/state', 'StatesController@update')->name('state_update');
    $router->put('/state/status', 'StatesController@updateStatus')->name('state_update_status');
    $router->delete('/state/{id}', 'StatesController@destroy')->name('state_delete');
